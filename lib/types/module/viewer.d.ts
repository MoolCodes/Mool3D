...
export interface ViewerType {
    ...
    initParticleEngine: FnTwoParams<ParticleEngineType, boolean, ParticleEngineType>;
    setParticleMode: FnThreeParams<ParticleEngineType, ParticleKeys, ParticleExamplesParams, unknown>;
